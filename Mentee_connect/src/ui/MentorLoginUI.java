...
public class MentorLoginUI {
    ...
    public MentorLoginUI() {
        ...
        JFrame frame = UITheme.createFrame("Mentor Login - Mentee Connect", 460, 500);
        ...
        JLabel title = UITheme.makeTitle("Mentor Login");
        JLabel sub = new JLabel("Sign in to your mentor account", SwingConstants.CENTER);
        ...
        loginBtn.addActionListener(e -> {
            try {
                ...
                String[] data = dao.getMentorLogin(email.getText(), new String(pass.getPassword()));
                if (data != null) {
                    ...
                    frame.dispose();
                    new MentorDashboardUI(mentorId, uname);
                } else {
